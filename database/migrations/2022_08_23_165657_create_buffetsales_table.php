...
class CreateBuffetsalesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('buffetsales', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('buffetorder_id')->references('id')->on('buffetorders')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('buffetsales');
    }
}
