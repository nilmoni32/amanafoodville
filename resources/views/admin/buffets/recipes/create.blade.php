...
<div class="row user">
    ...
    <div class="col-md-9">
        <div class="tile mx-2">
            <h5 class="tile-title">Add Food for the {{ $buffet->buffet_name }}</h5>
            <hr>
            <form action="{{ route('admin.buffet.recipe.store') }}" method="POST" role="form">
                @csrf
                <div class="tile-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mx-auto">
                            <div class="form-group">
                                <label class="control-label" for="recipe_id">Food Name</label>
                    ...
                    <div class="row d-print-none mt-2">
                        <div class="col-12 text-right">
                            <button class="btn btn-success" type="submit"><i
                                    class="fa fa-fw fa-lg fa-check-circle"></i>Save Food</button>
