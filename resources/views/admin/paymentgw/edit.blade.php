...
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="tile">
            ...
            <form action=" {{ route('admin.payment.gw.update') }} " method="POST" role="form">
                @csrf
                <div class="tile-body">
                    <input type="hidden" name="id" value="{{ $paymentgw->id }}">
                    <div class="col-md-8 mx-auto">
                        <div class="form-group">
                            <label class="control-label" for="bank_name">Name<span class="text-danger"> *</span></label>
                            <input class="form-control @error('bank_name') is-invalid @enderror" type="text" name="bank_name"
                                id="bank_name" value="{{ old('bank_name', $paymentgw->bank_name) }}" placeholder="Enter Name" required>
                    ...
                    <div class="col-md-8 mx-auto">
                        <div class="form-group">
                            ...
                            <select class="form-control custom-select mt-15 @error('bank_type') is-invalid @enderror"
                                ...
                                <option value="{{ $gw_type }}" {{ $gw_type == $paymentgw->bank_type ? "selected": "" }}>{{ $gw_type }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-8 mx-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('discount_percent') is-invalid @enderror"
                                ...
                                value="{{ old('discount_percent', $paymentgw->discount_percent ) }}"
                    ...
                    <div class="col-md-8 mx-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('discount_lower_limit') is-invalid @enderror"
                                ...
                                value="{{ old('discount_lower_limit', round($paymentgw->discount_lower_limit, 0)) }}"
                    ...
                    <div class="col-md-8 mx-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('discount_upper_limit') is-invalid @enderror"
                                ...
                                value="{{ old('discount_upper_limit', round($paymentgw->discount_upper_limit, 0)) }}"
