...
<div class="row user">
            ...
            <ul class="nav flex-column nav-tabs user-tabs">
                <li>
                    <a class="app-menu__item bg-white text-dark {{ Route::currentRouteName() == 'admin.products.edit' ? 'active' : ''}}"
                        href="{{ route('admin.products.edit', $productAttribute->product_id) }}">
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a class="treeview-item bg-white text-dark"
                                href="{{ route('admin.products.attribute.index', $productAttribute->product_id)}}">List
                                all
                                Attributes</a>
                        </li>
                        <li>
                            <a class="treeview-item bg-white text-dark"
                                href="{{ route('admin.products.attribute.create', $productAttribute->product_id)}}">Add
                                Attribute</a>
                        </li>
                    </ul>
                </li>
    ...
    <div class="col-md-9">
        <div class="tile mt-4">
            <div>
                <h3>Edit Attributes for the current food menu</h3>
            </div>
            <form action=" {{ route('admin.products.attribute.update') }} " method="POST" role="form"
                ...
                <div class="tile-body mt-5">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('size') is-invalid @enderror" type="text"
                            placeholder="Enter Size" id="size" name="size"
                            value="{{ old('size',$productAttribute->size) }}" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('price') is-invalid @enderror" type="text"
                                    ...
                                    value="{{ old('price', $productAttribute->price) }}" />
                                <div class="invalid-feedback active">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Enter special price"
                                    ...
                                    value="{{ old('special_price', $productAttribute->special_price) }}" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row d-print-none mt-2">
                        <div class="col-12 text-right">
                            ...
                            <a class="btn btn-danger"
                                href="{{ route('admin.products.attribute.index', $productAttribute->product_id) }}"><i
