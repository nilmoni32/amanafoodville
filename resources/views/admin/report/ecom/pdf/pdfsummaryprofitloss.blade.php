    ...
    <div class="content-wrapper">
        ...
        <div class="invoice-description">
            <div class="invoice-left-top float-left" style="width:100%;">
                ...
                @php $totalSalesCost=0.0; $totalSales=0.0;  @endphp
                @foreach($time_sales as $cart)
                @php $totalSalesCost += $cart->salesCost; $totalSales+=$cart->sales;@endphp
                @endforeach
                ...
                <tbody>           
                    <tr>
                        ...
                        <td class="text-left">{{ round(($totalSales - $totalSalesCost) ,2)  }}
                            {{ config('settings.currency_symbol') }} &nbsp; {{ "( " . round((($totalSales - $totalSalesCost) / $totalSalesCost)*100,2) ."% )" }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
