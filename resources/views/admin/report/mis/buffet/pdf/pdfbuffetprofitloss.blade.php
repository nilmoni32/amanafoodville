    ...
    <div class="content-wrapper">
        ...
        <div class="invoice-description">
            <div class="invoice-left-top float-left" style="width:100%;">
                <h6 style="margin-top:5px; text-align: left;">Report: Profit Loss Report ( Buffet ) </h6>
            ...
            <div class="invoice-left-top float-left" style="width:100%;">
                ...
                <p class="text-left" style="margin-top:5px;">
                    ...
                    <div style="line-height: 20px;">
                        <span>After Sales Vat </span><span style="padding-left: 71px;">:</span> {{ round($discount->total_vat,2) }} {{ config('settings.currency_symbol') }}
                    </div>
                    @endif
                    <div style="line-height: 20px;">
                    ...
                    <div style="line-height: 20px; font-weight:bold;">
                        <span>Net Profit/Loss</span><span style="padding-left:69px;">:</span>  {{ round(($discount->total_sales - $discount->total_vat) - ($totalSalesCost + $complimentary_sales_cost),2)  }} {{ config('settings.currency_symbol') }} 
