...
<head>
    ...
    <title>Product Dispose Details Report - {{ config('app.name', 'Funville') }}</title>
    <style>
        body{
    ...
    <div class="content-wrapper">
        ...
        <div class="invoice-description">
            <div class="invoice-left-top float-left" style="width:100%;">
                <h6 style="margin-top:5px; text-align: left;">Report: Product Dispose Report Details</h6>                
            </div>
            <div class="clearfix"></div>
        </div>
        ...
        <div class="product-description" style="margin-top:-10px;">
            ...
            <table  style="margin-bottom:-15px;">
                <tbody>
                    <tr>
                        <td class="record">Disposal Id:  #{{ $disposal->id }}</td>
                        <td class="record">Disposal Date: {{ explode(' ', $disposal->created_at)[0] }}</td>                        
                        <td class="record">Created By: {{ App\Models\Admin::find($disposal->admin_id)->name  }}</td>                        
                    </tr>
                </tbody>                
            </table>            
            <table>
