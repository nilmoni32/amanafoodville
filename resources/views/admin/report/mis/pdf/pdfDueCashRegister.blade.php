    ...
    <div class="content-wrapper">
        ...
        <div class="invoice-description">
            <div class="invoice-left-top float-left" style="width:100%;">
                <h5 style="margin-top:5px; text-align: left;">Report: Due Sales Cash Register </h5>
        ...
        <div class="mt-5" style="width:100%;">
            <div class="text-left" style="margin-top:5px; width:60%; float:left;">                
                <div style="line-height: 20px; font-weight:bold">
                    <span>Net Due Sales</span><span style="padding-left: 90px;">:</span>  {{ round($net_sales,2) }} {{ config('settings.currency_symbol') }}
                </div>
                <div style="line-height: 20px; font-weight:bold">
                    <span>Net Due Amount</span><span style="padding-left: 74px;">:</span>  {{ round($net_due,2) }} {{ config('settings.currency_symbol') }}
                </div>
                <div style="line-height: 20px; font-weight:bold">
                    <span>Net Due Sales Paid Amount</span><span style="padding-left: 5px;">:</span>  {{ round($net_receive,2) }} {{ config('settings.currency_symbol') }}
                </div>
                <div style="line-height: 20px;">
                    <span>Net Advance Payment </span><span style="padding-left: 43px;">:</span>  {{ round($net_booking_amount,2) }} {{ config('settings.currency_symbol') }}
                </div>
                <div style="line-height: 20px;">
                    <span>Net Cash Sales</span><span style="padding-left: 85px;">:</span>  {{ round($net_cash_sales,2) }} {{ config('settings.currency_symbol') }}
                </div>
                <div style="line-height: 20px;">
                    <span>Net Card Sales</span><span style="padding-left: 88px;">:</span>  {{ round($net_card_sales,2) }} {{ config('settings.currency_symbol') }}
                </div>
                <div style="line-height: 20px;">
                    <span>Net Mobile Bank Sales</span><span style="padding-left: 45px;">:</span>  {{ round($net_mobile_sales,2) }} {{ config('settings.currency_symbol') }}
                </div>
            </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ round($cash->order_total,2) }} {{ config('settings.currency_symbol') }}
                        </td>
                        <td>
                            {{ round($cash->receive_total,2) }} {{ config('settings.currency_symbol') }}
                        </td>
                        <td>
                            {{ round($cash->due_payable,2) }} {{ config('settings.currency_symbol') }}
                        </td> 
                        <td>
