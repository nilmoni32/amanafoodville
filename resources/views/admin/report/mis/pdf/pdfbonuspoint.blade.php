...
<head>
    ...
    <title>Customer Bonus Points - {{ config('app.name') }}</title>
    <style>
        body{
    ...
    <div class="content-wrapper">
        ...
        <div class="invoice-description">
            <div class="invoice-left-top float-left" style="width:100%;">
                <h5 style="margin-top:5px; text-align: left;">Report: Customer Bonus Points</h5>                
            </div>
            <div class="clearfix"></div>
        </div>
        <div class="product-description" style="margin-top:-10px;">
            <table>
                ...
                <tbody>
                    @foreach($bonus_points as $client)                   
                    <tr>
