...
<div class="app-title">
    ...
    <div class="pull-right">
        <a href="{{ route('admin.reports.pdfmodifiedgetvat', [$start_date, $end_date]) }}" class="btn btn-sm btn-dark"
            ...
            <div class="tile-body">
                <div class="row mb-4">
                    <div class="col-12 pt-3">
                        <form action="{{ route('admin.reports.percentage.getvat') }}" method="post"
