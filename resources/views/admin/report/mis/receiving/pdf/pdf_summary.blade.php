    ...
    <div class="content-wrapper">
        ...
        <div class="invoice-description">
            <div class="invoice-left-top float-left" style="width:100%;">
                <h6 style="margin-top:5px; text-align: left;">Report: Supplier Receiving Summary Report</h6>                
            </div>
            <div class="clearfix"></div>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $challan->id }}</td>
                        <td class="text-center">
                            {{ explode(' ', $challan->requisition_date)[0] }}
                        </td>
                        <td class="text-center">
                            {{ explode(' ', $challan->payment_date)[0] }}
                        </td>
                        <td class="text-center">{{ $challan->purpose }}</td>
                        <td class="text-center">{{ $challan->total_quantity }}</td>                            
                        <td class="text-center">
                            {{ round($challan->total_amount,2) }}
                            {{ config('settings.currency_symbol') }}
                        </td>
                        @php $total_qty += $challan->total_quantity;  $total_amount += $challan->total_amount; $counter++;@endphp
                    </tr>
                    @endforeach
