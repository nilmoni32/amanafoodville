...
<head>
    ...
    <title>Requisition Summary Report - {{ config('app.name', 'Funville') }}</title>
    <style>
        body{
    ...
    <div class="content-wrapper">
        ...
        <div class="invoice-description">
            <div class="invoice-left-top float-left" style="width:100%;">
                <h6 style="margin-top:5px; text-align: left;">Report: All Supplier Requisition Summary Report</h6>                
            </div>
            <div class="clearfix"></div>
        </div>
