    ...
    <div class="content-wrapper">
        ...
        <div class="invoice-description">
            <div class="invoice-left-top float-left" style="width:100%;">
                <h6 style="margin-top:5px; text-align: left;">Report: Single Supplier Return Report Details</h6>                
            </div>
            <div class="clearfix"></div>
        </div>
            ...
            <table  style="margin-bottom:-15px;">
                <tbody>
                    <tr>
                        ...
                        <td class="record">Return Date: {{ date('d-m-Y', strtotime(explode(' ', $return->chalan_date)[0])) }}</td>                        
