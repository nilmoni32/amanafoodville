    ...
    <div class="content-wrapper">
        ...
        <div class="invoice-description">
            <div class="invoice-left-top float-left" style="width:100%;">
                <h6 style="margin-top:5px; text-align: left;">Report: All Supplier Return Summary</h6>                
            </div>
            <div class="clearfix"></div>
        </div>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th class="text-center"> Ret Start Date </th>
                        <th class="text-center"> Ret End Date </th>
                ...
                <tbody>
                    @php $grnd_total_qty = 0; $grnd_total_amount = 0.0; $tot_rec =0.0; @endphp
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ App\Models\Supplier::find($return->supplier_id)->name }}</td>
                            <td class="text-center">
                                {{ explode(' ', date('d-m-Y', strtotime($return->startDate)))[0] }}
                            </td>
                            <td class="text-center">
                                {{ explode(' ', date('d-m-Y', strtotime($return->endDate)))[0] }}
                            </td>
                            <td class="text-center">{{ $return->TotalReturnNo }}</td>
                            <td class="text-center">{{ $return->TotalReturnQty }}</td>                            
                            <td class="text-center">
                                {{ round($return->TotalCostAmount,2) }}
                                {{ config('settings.currency_symbol') }}
                            </td>
                            @php $grnd_total_qty += $return->TotalReturnQty;  $grnd_total_amount += $return->TotalCostAmount; $tot_rec += $return->TotalReturnNo; @endphp
                        </tr>
                        @endforeach
                        <tr>
