...
<head>
    ...
    <title>Yearly Sale - {{ config('app.name', 'Funville') }}</title>
    <style>
        .content-wrapper {
            margin-left: auto;
            margin-right: auto;
    ...
    <div class="content-wrapper">
        ...
        <div class="invoice-description" style="margin-bottom:0px;">
            <div class="invoice-left-top float-left">
                <h5 style="margin-top:10px;">Yearly Sale in Amount</h5>
            </div>
            <div class="clearfix"></div>
        </div>
        <div class="product-description" style="margin-top:-10px;">
            <table>
                ...
                <tbody>
                    @php $i =1; @endphp
                    @foreach($yearly_totals as $yeartotal)
